        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Header row */}
                    <div className="flex items-center justify-between mb-4 relative z-10 border-b border-cyan-500/10 pb-3">
                        <div className="flex items-center gap-2">
                            <Fingerprint className="w-4 h-4 text-cyan-400" />
                            <span className="text-[11px] font-bold text-cyan-400 font-mono uppercase tracking-widest">
                                AUDIT_PASS : TOKEN_MINTED
                            </span>
                        </div>
                        <div className="flex items-center gap-1.5 text-[10px] bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 px-2 py-0.5 font-mono shadow-[0_0_10px_rgba(34,211,238,0.1)]"
                    ...
                    <div className="relative z-10 space-y-3 mt-4">
                        {/* Proof ID */}
                        <div className="bg-[#060a12] border border-cyan-500/15 p-2 flex items-center justify-between"
                             style={{ clipPath: 'polygon(6px 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%, 0 6px)' }}>
                            <div className="flex items-center gap-2">
                                <Hash className="w-3.5 h-3.5 text-cyan-400/60 shrink-0" />
                                <span className="text-[10px] font-mono tracking-widest text-cyan-400/60 uppercase font-bold shrink-0">PROOF:</span>
                            </div>
                            <span className="text-xs font-mono text-white/90 truncate max-w-[150px] sm:max-w-[200px]">{proofId.substring(0, 16)}...</span>
                        </div>

                        {/* Token TXID */}
                        <div className="bg-[#060a12] border border-cyan-500/15 p-2 flex items-center justify-between gap-4"
                             style={{ clipPath: 'polygon(6px 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%, 0 6px)' }}>
                            <div className="flex items-center gap-2">
                                <Hash className="w-3.5 h-3.5 text-cyan-400/60 shrink-0" />
                                <span className="text-[10px] font-mono tracking-widest text-cyan-400/60 uppercase font-bold shrink-0">TXID:</span>
                            </div>
                    ...
                    <div className="relative z-10 mt-5 pt-1">
                        <a
                            ...
                            className="w-full h-9 bg-cyan-500/5 hover:bg-cyan-500/15 border border-cyan-500/30 text-cyan-400 font-mono font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(34,211,238,0.08)] group"
                            style={{ clipPath: 'polygon(6px 0, 100% 0, 100% calc(100% - 6px), calc(100% - 6px) 100%, 0 100%, 0 6px)' }}
                        >
